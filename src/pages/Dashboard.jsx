...
import { useUserActions } from "../store/userActions.js";
...
const Dashboard = () => {
  ...
  const { loading, isAuthenticated, error, user } = useRecoilValue(userState);
  const { logout, clearAllUserErrors } = useUserActions();
